    ...
    <div class="row" style="background-color:white; padding: 40px; padding-bottom: 80px;">
      ...
      <div class="col-md-10 mx-auto">
         <table class="table">
          @csrf
		  <thead>
            <tr><h2 ><span class="label label-primary">Tên môn học :</span></h2></tr>
			</thead>
          <tr> 
		  <tbody>
		  <td><h2 ><span class="label label-primary">{{$monhoc->tenmonhoc}}</span></h2></td>
		  </tbody>
		  </tr>
		   </table>
		    <table class="table">
            ...
            @foreach($worktask as $i =>$wt )
					 ...
					 <tbody>
					  <tr>
	                    <td rowspan="3"><?php static $k=0;$k=$k+1; echo "Task : ".$k; ?></td>
						<td rowspan="3">{{$wt}}</td>
						 <td rowspan="3"> 
