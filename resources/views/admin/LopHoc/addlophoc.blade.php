...
<form method="post" action="{{route('qlsvlophoc.store')}}">
    ...
    <div class="form-group">
        <div class="col-sm-6 col-xs-6">
            ...
            <select name="id_khoahoc" id="id_khoahoc" class="form-control" onchange="taotenlop()">
                <option>--Chọn--</option>
        ...
        <div class="col-sm-6 col-xs-6">
            <label for="">Môn</label>
            <select name="id_monhoc" id="id_monhoc" class="form-control" onchange="taotenlop()">
                <option>--Chọn--</option>
    ...
    <div class="form-group">
        <div class="col-sm-6 col-xs-6" style=""><label>Giảng viên</label>
            <select name="id_giangvien" class="form-control" onchange="taotenlop()" id="id_giangvien">
                <option>--Chọn--</option>
