...
<footer class="footer-distributed" style="margin-top: 0px;">
    ...
    <div class="form-group row" style="width: 100%; ; margin:0px; ">
        <div class="col-xs-6">
            <p><span style="color: #fff;">Liên kết :</span></p>
            <a style="text-align: center; color: #fff;" href="http://ispacedanang.edu.vn/">ispacedanang.edu.vn</a>
            <a style="text-align: center; color: #fff;" href="https://aspace.edu.vn/">aspace.edu.vn</a>
        </div>
        <div class="col-xs-6">
            <p style="color: #fff;">Liên hệ :</p><a>0774 955 635</a>
