            ...
            <tr>
                ...
                <td width=100%>
                    ...
                    <ul style="list-style: none; margin-top: 16px; margin-left: -17px; ">
                        <li style="float: left; margin-right: 3px; "><a class="btn-sm btn-success" style="padding: 5px 50px;" href="/sinh_vien/viewxinnghi/?id_lophoc={{$value->id_lophoc}}&id_sinhvien={{$value->id_sinhvien}}">Xin nghỉ</a></li>
                    </ul>
                </td>
